    ...
    def _process_message(self, msg: Message) -> None:
        ...
        try:
            ...
            try:
                ...
                logger.info("kafka Received prediction request")
...
async def predict(request: PredictionRequest) -> PredictionResponse:  # Use global var
    ...
    try:
        ...
        try:
            ...
            logger.info(f"HTTP prediction request received with {row_count} rows")
        except Exception:
            logger.info("HTTP prediction request received")
