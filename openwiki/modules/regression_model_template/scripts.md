...
source_path: "[src/regression_model_template/scripts.py](/src/regression_model_template/scripts.py)"
...
* **Source File Reference:** [`src/regression_model_template/scripts.py`](/src/regression_model_template/scripts.py) (Lines: L1-L55)
...
### `main() -> None`
* **Line Citation:** [`src/regression_model_template/scripts.py:L15-L55`](/src/regression_model_template/scripts.py#L15-L55)
* **Visibility:** Public (`+`)
