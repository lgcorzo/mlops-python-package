...
* **Source File Reference:** `src/regression_model_template/controller/kafka_app.py` (Lines: L1-L462)
* **Upstream Dependencies:** [[Modules/RegressionModelTemplate/Core/Models]], `confluent_kafka`, `fastapi`, `pydantic`
...
### `RateLimiter` (`src/regression_model_template/controller/kafka_app.py:L70-L112`)
...
### `FastAPIKafkaService` (`src/regression_model_template/controller/kafka_app.py:L184-L386`)
...
### `PredictionService` (`src/regression_model_template/controller/kafka_app.py:L442-L462`)
