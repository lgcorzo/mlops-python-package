...
* **Source File Reference:** `src/regression_model_template/core/metrics.py` (Lines: L1-L148)
* **Upstream Dependencies:** `scikit-learn`, `mlflow`
* **Downstream Consumers:** [[Modules/RegressionModelTemplate/Jobs/Evaluations]], [[Modules/RegressionModelTemplate/Jobs/Training]], [[Modules/RegressionModelTemplate/Jobs/Tuning]]
...
### `Metric` (`src/regression_model_template/core/metrics.py:L27-L95`)
...
### `SklearnMetric` (`src/regression_model_template/core/metrics.py:L98-L117`)
...
### `Threshold` (`src/regression_model_template/core/metrics.py:L126-L148`)
