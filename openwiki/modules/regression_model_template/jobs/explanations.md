...
* **Source File Reference:** `src/regression_model_template/jobs/explanations.py` (Lines: L16-L78)
* **Upstream Dependencies:** [[Modules/RegressionModelTemplate/Jobs/Base]], [[Modules/RegressionModelTemplate/Core/Models]]
...
### `ExplanationsJob` (`src/regression_model_template/jobs/explanations.py:L16-L78`)
