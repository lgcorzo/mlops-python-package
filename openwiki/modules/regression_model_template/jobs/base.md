...
* **Source File Reference:** `src/regression_model_template/jobs/base.py` (Lines: L21-L85)
* **Upstream Dependencies:** [[Modules/RegressionModelTemplate/IO/Services]]
...
### `Job` (`src/regression_model_template/jobs/base.py:L21-L85`)
