...
source_path: "[src/regression_model_template/settings.py](/src/regression_model_template/settings.py)"
...
* **Source File Reference:** [`src/regression_model_template/settings.py`](/src/regression_model_template/settings.py) (Lines: L1-L25)
