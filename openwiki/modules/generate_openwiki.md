...
timestamp: "2026-08-15T05:57:15Z"
...
sequenceDiagram
    ...
    get_deleted_files->>run_command: invoke
    get_deleted_files->>split: invoke
    get_deleted_files->>endswith: invoke
    get_deleted_files->>is_ignored: invoke
    ...
    parse_existing_used_by->>compile: invoke
    parse_existing_used_by->>findall: invoke
    parse_existing_used_by->>sorted: invoke
    parse_existing_used_by->>exists: invoke
    parse_existing_used_by->>open: invoke
    parse_existing_used_by->>read: invoke
    parse_existing_used_by->>split: invoke
    compute_used_by->>replace: invoke
    compute_used_by->>items: invoke
    compute_used_by->>sorted: invoke
    compute_used_by->>splitext: invoke
    compute_used_by->>basename: invoke
    compute_used_by->>startswith: invoke
    compute_used_by->>append: invoke
    ...
    main->>exists: invoke
    main->>parse_existing_used_by: invoke
    main->>compute_used_by: invoke
    main->>sorted: invoke
...
### `parse_existing_used_by(filepath: Any) -> Any`
No description available.
...
### `compute_used_by(relative_filepath: Any) -> Any`
No description available.
