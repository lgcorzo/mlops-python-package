...
sequenceDiagram
    ...
    generate_package_diagram_content->>list: invoke
    generate_package_diagram_content->>split: invoke
    generate_package_diagram_content->>fromkeys: invoke
    ...
    generate_call_graph->>list: invoke
    generate_call_graph->>get: invoke
    generate_call_graph->>fromkeys: invoke
