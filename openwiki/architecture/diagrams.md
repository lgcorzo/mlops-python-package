...
digraph CallGraph {
    ...
    "get_deleted_files()" -> "is_ignored()"
    "get_deleted_files()" -> "run_command()"
    "get_deleted_files()" -> "split()"
    ...
    "parse_existing_used_by()" -> "read()"
    "parse_existing_used_by()" -> "split()"
    "parse_file()" -> "load()"
