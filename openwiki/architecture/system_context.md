...
### A. MLflow Tracking & Model Registry (`src/regression_model_template/io/services.py:L162-L252`, `registries.py:L69-L317`)
...
### B. Apache Kafka Event Streaming (`src/regression_model_template/controller/kafka_app.py:L184-L386`)
...
### C. OpenTelemetry OTLP Collector (`src/regression_model_template/io/services.py:L1-L124`)
...
### D. Data Storage & Parquet I/O (`src/regression_model_template/io/datasets.py:L19-L125`)
